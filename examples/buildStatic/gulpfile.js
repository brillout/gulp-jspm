...
/**
 * For arithmetic to work with buildStatic, you must define any modules listed in the expression in
 * builderConfig.globalDeps as follows. The result will assume that the defined global is available at runtime.
 *
...
gulp.task('arithmetic', ['clean'], function () {
    ...
    var expression = '- src/utils/sayHello.js',
        ...
        builderConfig = {
            globalDeps: {
                // module: globalVar
                "src/utils/sayHello.js": "SAY_HELLO" // assumes window.SAY_HELLO is available at runtime.
            }
        };
